...
// However, this is a good starting point to make your own implementation.
// Using this service, it's possible to connect two or more chats in the same application for demonstration purposes.
const enums_1 = require('@chatscope/use-chat/dist/enums/index')
const events_1 = require('@chatscope/use-chat/dist/events/index')
const { UserTypingEvent } = require('@chatscope/use-chat/dist/events/index');
