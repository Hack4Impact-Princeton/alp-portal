...
export default function InstructionGroupCard(props) {
  // needs a prop for which group it is: 0, 1, 2, 3; this will determine what cards are created
    ...
    let content = <InstructionCollectCard paddingTop={3} stepNum={1} numBooksCollected={500} driveStatus={props.driveStatus} driveCode={props.driveCode}></InstructionCollectCard>
