...
const BroadcastMessage: React.FC<BroadcastMessageProps> = ({ broadcast, isRead, onRead }) => {
    return (
        <Grid onClick={() => onRead(broadcast.id, true)} style={{ display: "flex", flexDirection: "column", padding: 10, margin: 5, border: isRead ? "1px solid gray" : "1.5px solid black", fontWeight: isRead ? 200 : 800, cursor: "pointer" }}>
